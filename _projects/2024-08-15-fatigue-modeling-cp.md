...
<div class="row mt-3">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">CASEM Conference Presentation</h5>
        <p class="card-text">An investigation of active force in skeletal muscle fibres from children with cerebral palsy. Canadian Society of Sport and Exercise Medicine Conference (2023)</p>
      </div>
    </div>
  </div>
</div>
